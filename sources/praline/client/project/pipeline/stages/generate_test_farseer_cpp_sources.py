...
@stage(requirements=[
           ['project_directories', 'test_farseer_sources', 'external_executables', 'external_libraries', 'main_library'],
           ['project_directories', 'test_farseer_sources', 'external_executables', 'external_libraries'],
       ], 
       output=['generated_test_farseer_cpp_headers', 'generated_test_farseer_cpp_sources'])
def generate_test_farseer_cpp_sources(arguments: StageArguments):
    ...
    resources['generated_test_farseer_cpp_headers'] = generated_farseer_cpp_headers
    resources['generated_test_farseer_cpp_sources'] = generated_farseer_cpp_sources
