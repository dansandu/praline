...
@stage(requirements=[['project_directory', 'pralinefile', 'compiler', 'resources_root', 'resources', 'headers_root', 'formatted_headers', 'main_library', 'main_library_interface', 'main_library_symbols_table', 'test_results'],
                     ['project_directory', 'pralinefile', 'compiler', 'resources_root', 'resources', 'headers_root', 'formatted_headers', 'main_library', 'main_library_interface', 'main_library_symbols_table'],
                     ['project_directory', 'pralinefile', 'compiler', 'resources_root', 'resources', 'headers_root',           'headers', 'main_library', 'main_library_interface', 'main_library_symbols_table', 'test_results'],
                     ['project_directory', 'pralinefile', 'compiler', 'resources_root', 'resources', 'headers_root',           'headers', 'main_library', 'main_library_interface', 'main_library_symbols_table']],
       output=['main_library_package'], cacheable=True)
def package_main_library(file_system: FileSystem, resources: StageResources, cache: Dict[str, Any], program_arguments: Dict[str, Any], configuration: Dict[str, Any], remote_proxy: RemoteProxy):
    ...
    if main_library_interface:
        package_files.append((main_library_interface, f'libraries_interfaces/{basename(main_library_interface)}'))
    if main_library_symbols_table:
        package_files.append((main_library_symbols_table, f'symbols_tables/{basename(main_library_symbols_table)}'))
    pack(file_system, package_path, package_files, cache)

    resources['main_library_package'] = package_path
