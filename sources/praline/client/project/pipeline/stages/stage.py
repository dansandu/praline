...
class Stage:
    ...
    cacheable        : bool
    exposed          : bool
    invoker          : Callable[[FileSystem, StageResources, Dict[str, Any], Dict[str, Any], Dict[str, Any], RemoteProxy], None]
...
def stage(_function        : Callable[[FileSystem, StageResources, Dict[str, Any], Dict[str, Any], Dict[str, Any], RemoteProxy], None] = None,
          requirements     : List[List[str]] = [[]],
          output           : List[str] = [],
          ...
          exposed          : bool = False):
    def decorator(function: Callable[[FileSystem, StageResources, Dict[str, Any], Dict[str, Any], Dict[str, Any], RemoteProxy], None]):
