...
from praline.client.project.pipeline.stages.load_main_resources import load_main_resources
...
class LoadMainResourcesStageTest(TestCase):
    def test_load_main_resources_stage(self):
        ...
        self.assertCountEqual(resources['main_resources'], expected_resources)
