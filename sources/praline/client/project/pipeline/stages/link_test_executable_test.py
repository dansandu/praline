...
class CompilerMock:
    ...
    def link_executable_using_cache(self,
        ...
        self.test_case.assertTrue(is_test_executable)
...
class LinkTestExecutableStageTest(TestCase):
    def test_link_test_executable(self):
        ...
        object_a = object_path('org-art-a.obj')
        object_b = object_path('org-art-b.obj')
        object_c = object_path('org-art-executable.obj')
        object_d = object_path('org-art-c.test.obj')
        object_e = object_path('org-art-d.test.obj')
        object_f = object_path('org-art-executable.test.obj')
