...
class ProgressBarTest(TestCase):
    ...
    def test_format_timedelta(self):
        ...
        self.assertEqual(format_time(milliseconds=1000), "1s")
    ...
    def test_early_exit(self):
        ...
        expected_lines = [
            ...
            "\x1B[2F\x1B[2M stage \x1B[32mdone\x1B[0m\n",
        ]
    ...
    def test_exception(self):
        ...
        expected_lines = [
            ...
            "\x1B[2F\x1B[2M stage\n",
            "  \x1B[34m==========\x1B[0m========================================  20.00%\n",
            "\x1B[2F\x1B[2M stage \x1B[31mfailed\x1B[0m\n",
    ...
    def test_last_inch_exception(self):
        ...
        expected_lines = [
            " stage\n",
            "  ==================================================   0.00%\n",
            "\x1B[2F\x1B[2M stage short_text\n",
            "  ==================================================   0.00%\n",
            "\x1B[2F\x1B[2M stage short_text\n",
            "  \x1B[34m=================================================\x1B[0m=  99.99%\n",
            "\x1B[2F\x1B[2M stage short_text \x1B[31mfailed\x1B[0m\n",
    ...
    def test_nonzero_resolution(self):
        ...
        expected_lines = [
            ...
            "\x1B[2F\x1B[2M stage ...ng_to_display_inside_the_progress_bar\n",
            "  \x1B[34m=========================\x1B[0m=========================  50.00%\n",
            "\x1B[2F\x1B[2M stage ...ng_to_display_inside_the_progress_bar\n",
            "  \x1B[34m=================================================\x1B[0m=  99.99%\n",
            "\x1B[2F\x1B[2M stage \x1B[32mdone\x1B[0m\n",
    ...
    def test_zero_resolution_failure(self):
        ...
        expected_lines = [
            " stage name\n",
            "  ==================================================\n",
            "\x1B[2F\x1B[2M stage name \x1B[31mfailed\x1B[0m\n",
            "  \x1B[31m==================================================\x1B[0m\n",
        ]
    ...
    def test_zero_resolution_success(self):
        ...
        expected_lines = [
            " stage name\n",
            "  ==================================================\n",
            "\x1B[2F\x1B[2M stage name \x1B[32mdone\x1B[0m\n",
        ]
    ...
    def test_summary(self):
        ...
        expected_lines = [
            " test\n",
            "  ==================================================   0.00%\n",
            "\x1B[2F\x1B[2M test myTestCase\n",
            "  ==================================================   0.00%\n",
            "\x1B[2F\x1B[2M test myTestCase\n",
            "  \x1B[34m=================================================\x1B[0m=  99.99%\n",
            "\x1B[2F\x1B[2M test myTestCase\n",
            "  \x1B[34m=================================================\x1B[0m=  99.99%\n",
            "\x1B[2F\x1B[2M test 5356 asserts in 21 tests \x1B[32mdone\x1B[0m\n",
        ]
        ...
        self.assertEqual(file_system.stdout.getvalue().encode(), ''.join(expected_lines).encode())
